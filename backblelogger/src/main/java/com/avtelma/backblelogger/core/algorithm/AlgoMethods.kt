 ...
 */
fun Mean(Data_Chunk : ArrayList<XYZ>) : ArrayList<Double> {
...
fun Deviation(Data_Chunk: ArrayList<XYZ>, Mean : ArrayList<Double>) : ArrayList<Double>{
...
fun calculateStandardDeviation(Data_Chunk: ArrayList<XYZ>): ArrayList<Double> {
    //int[] array;
...
fun VectorNorm(Vector : ArrayList<Double>): Double {
 ...
 */
fun NormVector(Vector: ArrayList<Double>): ArrayList<Double> {
...
fun DotProd(V1: ArrayList<Double>, V2 : ArrayList<Double>) : Double {
    when(V1.size){
...
fun CrossProd(V1: ArrayList<Double>, V2: ArrayList<Double>) : ArrayList<Double>{
    return arrayListOf(
        (V1[1]*V2[2]-V1[2]*V2[1]),
        (V1[2]*V2[0]-V1[0]*V2[2]),
        (V1[0]*V2[1]-V1[1]*V2[0])
 ...
 */
fun RotVecCalc(V1: ArrayList<Double>, V2: ArrayList<Double>): ArrayList<Double> {
    var RotVec : ArrayList<Double> = CrossProd(V1, V2)
    var Cosang = 0.0

    if ((VectorNorm(V1)*VectorNorm(V2)) == 0.0){
        Cosang = 0.0
    }else{
 ...
 */
fun Axang2Q(RotVec : ArrayList<Double>): ArrayList<Double> {
 ...
 */
fun Quat2DCM(Q : ArrayList<Double>): Array<Array<Double>> {
    var Qnew = NormVector(Q)
 ...
 */
fun Quatrotate(Q : ArrayList<Double>,V : ArrayList<Double>): ArrayList<Double> {
...
fun Quatdivide(Q: ArrayList<Double>,R : ArrayList<Double>): ArrayList<Double> {
 ...
 */
fun AngleBetweenQ(Q1 : ArrayList<Double>, Q2 : ArrayList<Double>): Double {
 ...
 */
fun Find_max_index(V: ArrayList<Double>): Int {
...
fun Quat2Axang(q : ArrayList<Double>) : ArrayList<Double>{
